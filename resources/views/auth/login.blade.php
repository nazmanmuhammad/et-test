    ...
    <div class="card-body">
      ...
      <form action="{{route('login')}}" method="post">
        ...
        <div class="input-group mb-3">
          <input type="email" class="form-control @error('email')is-invalid @enderror" placeholder="Email @error('email') {{ $message }} @enderror" name="email">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control @error('email')is-invalid @enderror" placeholder="Password @error('password') {{ $message }} @enderror" name="password">
          <div class="input-group-append">
            <div class="input-group-text">
