  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <form action="{{ route('register') }}" method="post">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control @error('password')is-invalid @enderror" placeholder="Retype password" type="password" name="password_confirmation">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
      ...
      <a href="{{ route('login') }}" class="text-center">Saya sudah mendaftar</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
